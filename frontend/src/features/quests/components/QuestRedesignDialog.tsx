  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          id={`redesign-${quest.id}-description`}
          className="quest-dialog-copy"
        >
        ...
        <form onSubmit={handleSubmit} noValidate>
          <fieldset
            ...
            aria-describedby={
              validationErrors.reasonCode ? 'reason-code-error' : undefined
            }
          >
          ...
          <div className="reason-note-field">
            <div className="label-row">
              ...
              <span>
                {reasonNote.length}/{QUEST_REASON_NOTE_MAX_LENGTH}
              </span>
            </div>
            <textarea
