...
- [백엔드 도메인/API 계약](docs/BACKEND_DOMAIN_API.md)
- [프론트엔드 화면 흐름 설계](docs/FRONTEND_SCREEN_FLOW.md)
- [MVP 작업 우선순위](docs/MVP_WORK_PLAN.md)
- [코드 품질 가드레일](docs/CODE_QUALITY_GUARDRAILS.md)
- [백엔드 에이전트 역할](docs/agents/ROLE_BACKEND.md)
